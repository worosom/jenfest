              ...
              <div className="flex items-center gap-4">
                {userData?.campLocation && (
                  <div className="flex items-center gap-1 text-sm text-gray-600">
                    ...
                    <span>
                      Camp at X: {Math.round(userData.campLocation.x)}, Y:{" "}
                      {Math.round(userData.campLocation.y)}
                    </span>
                  </div>
                )}
                  ...
                  >
                    ...
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex items-center gap-2">
                        {post.isActivity && (
                          <div className="flex items-center gap-1 text-[var(--color-clay)] text-sm">
                            <Calendar size={16} />
                            <span>Activity</span>
                          </div>
                        )}
