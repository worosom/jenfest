    ...
    <>
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-4">
        {posts.map((post) => (
          <div
            key={post.id}
            className="bg-[var(--color-sand-light)] border border-[var(--color-warm-gray-300)] rounded-lg shadow-lg p-4"
          >
            {/* Activity badge if applicable */}
            {post.isActivity && (
              <div className="flex items-center gap-1 text-[var(--color-clay)] text-sm font-medium mb-2">
                <Calendar size={16} />
                <span>Activity</span>
              </div>
            )}
